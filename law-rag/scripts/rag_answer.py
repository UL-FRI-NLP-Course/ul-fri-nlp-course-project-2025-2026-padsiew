...
def make_prompt(question: str, contexts):
    ...
    return f"""Odgovori na vprašanje z uporabo spodnjih pravnih virov.

Pravila:
- Odgovori v slovenščini.
- Uporabi samo navedene vire.
- Ne ugibaj in ne dodajaj informacij, ki jih ni v virih.
- Če je mogoče, prepiši bistveni del odgovora neposredno iz vira.
- Odgovor naj ima največ 2 povedi.
- Na koncu dodaj sklic v obliki [1].
